<template>
    ...
    >
      <div class="flex items-center justify-between">
        <div class="relative w-16 h-16">
          <img
            class="border border-gray-100 rounded-full shadow-sm"
        ...
        <div class="relative overflow-hidden rounded-lg shadow-2xl lg:flex">
          ...
          <div class="relative bg-white lg:w-7/12">
            ...
            >
              <p>
                As
                <strong class="font-medium text-gray-900">Slack</strong> grows
  ...
  <div class="flex items-center h-full banner-1">
    <div class="w-7/12 p-12">
      ...
      <a class="text-2xl text-blue-600 underline font-work_sans"
        >📧 hire@author.com</a
      >
    </div>
